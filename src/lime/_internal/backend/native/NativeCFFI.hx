...
class NativeCFFI
{
	...
	@:cffi private static function lime_system_get_timer_ns():Float;
	...
	@:hlNative("lime", "hl_system_get_timer_ns") private static function lime_system_get_timer_ns():Float
	{
		return 0;
	}
